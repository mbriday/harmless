...
NB_INSTR_ELF_FILE=50000000 # DEFAULT VALUE OVERIDE BY SCRIPT PARAMETERS
M_MODEL_NAME="AT90CAN128" # COULD NOT BE APPLY --> TO DO : correct it
...
if len(param)>=7 :
	...
	# Info
	print "Simulation of ",M_MODEL_NAME,"modele name may have to be change l.32 & 38 in bench_simulator.py"
