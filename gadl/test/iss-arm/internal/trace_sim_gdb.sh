...
sed "s/\@LOOP\@/$2/;s|\@FILE\@|$1|;s/\@START\@/$START/" script_gdb.template > script_gdb
...
$GDB -x script_gdb -batch 2>&1 |sed "1,7d;/^\([0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][,]\)/! d"
exit 0
