...
# TEST : basic task scheduling, stack monitoring is in use
# DESCRIPTION :
# Main task is StartTask activate Task 2, 3 and 4
...
print "-- Task scheduling & Stack monitoring --"
f.execInst(100000000) #run until breakpoint
