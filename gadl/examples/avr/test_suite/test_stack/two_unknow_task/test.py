...
# TEST : Two task are unknown
# DESCRIPTION :
# This test verify task scheduling when two task are unknown (ex. not add by user)
# Task 2 and 3 are not add (unknown)
...
f=arch()
f.readCodeFile("./two_unknown_task")
