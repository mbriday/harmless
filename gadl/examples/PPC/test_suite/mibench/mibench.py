...
def compileTest(files, outputName):
	...
	compileStr = xtools+"gcc -o "+outputName+".elf "
	for f in files:
		compileStr += f+" "
	print "compile file: "+outputName+".elf"
	compileStr += "internal/stub.c -g -lm -msoft-float -Wl,-n,-T./internal/script.ld,./internal/crt0.o,-Map,"+outputName+".map"
