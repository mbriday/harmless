...
{
	//const u32 arg0 = a->SRU_GPR_read32(3); //depends on the ABI.
	const u32 arg1 = a->SRU_GPR_read32(4);
	const u32 arg2 = a->SRU_GPR_read32(5);
	//const u32 arg3 = a->SRU_GPR_read32(6);
	string name = "";
	int index = 0;
	bool end = false;
	...
	if(f)
	{
		...
		a->SRU_GPR_write32(3, (u32)(fd));	//depends on the ABI.
...
{
	//const u32 arg0 = a->SRU_GPR_read32(3); //_reent *
	const u32 arg1 = a->SRU_GPR_read32(4); //file descriptor.
	const u32 arg2 = a->SRU_GPR_read32(5); //ptr
	const u32 arg3 = a->SRU_GPR_read32(6); //len
	...
	if(f)
	{
		...
		a->SRU_GPR_write32(3, (u32)(nbVal)); //depends on the ABI.
	} else {
...
{
	const u32 arg1 = a->SRU_GPR_read32(3); //file descriptor.
	const u32 arg2 = a->SRU_GPR_read32(4); //buf
	const u32 arg3 = a->SRU_GPR_read32(5); //len
	...
	if(f)
	{
		...
		delete buf;
		//the return value is the number of bytes read.
		a->SRU_GPR_write32(3, (u32)(ret)); //depends on the ABI.
	} else {
		cerr << "File descriptor does not match!" << endl;
	}
	return false; //do not remove action
...
{
	const u32 arg1 = a->SRU_GPR_read32(3); //char to write.
