 ...
 * $Rev: 6 $
 * $Author: mik $
 * $URL: https://ac2cpp.rts-software.org/svn/main.cpp $
...
{
	cout << "ac2cpp is copyright (c) IRCCyN 2005+" << endl;
	cout << "ac2cpp est protege par la loi sur la propriete intellectuelle" << endl;
	cout <<  endl;
	...
	cout << endl;
	cout << "Usage: ac2cpp [options] file" << endl;
	cout << "The file is the ac2ac file." << endl;
	cout << "Options:" << endl;
	cout << "--help\t\tthis help" << endl;
	cout << "--verbose|-v \tcause ac2cpp to be verbose: showing septs of data generation (to stderr)" << endl;
}
