...
class instruction;
class instructionPerPipelineStage;
//class dataDependencyInstruction;
...
class systemConfiguration
{
	...
	std::vector<std::string> m_DapaDependencyInstructionNameVector;
...
//	std::vector<dataDependencyInstruction *> m_DapaDependencyInstructionVector;
	...
	void processSymbolInstruction(int index, std::ifstream &file);
//	void processSymbolDapaDependencyInstruction(int index, std::ifstream &file);
	...
	PMUInt const getNumberOfInstruction() {return m_instructionVector.size();};
	...
	std::vector<instruction *> &getInstructionVector() {return m_instructionVector;};
//	std::vector<dataDependencyInstruction *> &getDataDependencyInstructionVector() {return m_DapaDependencyInstructionVector;};
